...
public class MonoColorSkybox extends AbstractSkybox {
    ...
    public void render(WorldRendererAccess worldRendererAccess, MatrixStack matrices, float tickDelta) {
        if (this.alpha > 0) {
            ...
            RenderSystem.color4f(this.color.getRed(), this.color.getGreen(), this.color.getBlue(), 1.0F);
            ...
            if (world.getSkyProperties().isAlternateSkyColor()) {
                RenderSystem.color4f(this.color.getRed() * 0.2F + 0.04F, this.color.getBlue() * 0.2F + 0.04F, this.color.getGreen() * 0.6F + 0.1F, 1.0F);
            } else {
                RenderSystem.color4f(this.color.getRed(), this.color.getBlue(), this.color.getGreen(), 1.0F);
            }
