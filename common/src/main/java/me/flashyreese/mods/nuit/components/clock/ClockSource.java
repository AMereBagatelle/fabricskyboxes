 ...
 *
 * <p>Minecraft 1.21.1 predates named world clocks, so this version supports the default day-time clock,
 * game time, and fixed time.</p>
 */
public interface ClockSource {
    String WORLD_CLOCK_UNAVAILABLE = "Named world clocks are unavailable on Minecraft 1.21.1";
    ...
    static WorldClockSource worldClock(ResourceLocation clock) {
    ...
    /** Returns render-interpolated ticks. */
